...
PUSHD "temp_zip"
START "" /B /WAIT "..\7za.exe" a -tzip -mx=9 "CoolPlayer_%CPVER%_%2.zip" >NUL
IF %ERRORLEVEL% NEQ 0 CALL :SUBMSG "ERROR" "Compilation failed!"

CALL :SUBMSG "INFO" "CoolPlayer_%CPVER%_%2.zip created successfully!"

MOVE /Y "CoolPlayer_%CPVER%_%2.zip" "..\" >NUL 2>&1
POPD
