@ECHO OFF
rem *
rem * build.bat, Batch file "wrapper" for makefile.mak, 
...
TITLE Building CoolPlayer x86 with WDK...
ECHO. & ECHO.
...
TITLE Building CoolPlayer x64 with WDK...
ECHO. & ECHO.
...
:END
TITLE Building CoolPlayer with WDK - Finished!
ENDLOCAL
EXIT /B
